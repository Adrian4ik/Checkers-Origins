...
public class NamesTags
{
    ...
    public static readonly string ARENA_1_SCENE = "Arena1";
    public static readonly string ARENA_2_SCENE = "Arena2";
    public static readonly string ARENA_3_SCENE = "Arena3";
